(function () {
  ...
  var i18n = {
    pt: {
      ...
      'omnia.footerTag': 'Consultoria moçambicana para instituições que precisam de estratégia clara, execução rigorosa e resultados verificáveis.',
      /* Comum (todas as páginas) */
      'common.home': 'Início',
      'common.contact': 'Contacto',
      'common.contactUs': 'Fale connosco',
      'common.initiativaDeCarvalho': 'Uma iniciativa DeCarvalho',
      'common.footerTag': 'Estratégia clara, execução rigorosa e resultados verificáveis.',
      ...
      'contact.lead': 'Para pedidos comerciais, parcerias ou apoio técnico, contacte a equipa DeCarvalho. Respondemos com próximos passos claros e adequados ao seu contexto.',
      'contact.name': 'Nome *',
    ...
    en: {
      ...
      'omnia.footerTag': 'Mozambican consulting for institutions that need clear strategy, rigorous delivery and verifiable results.',
      /* Common (all pages) */
      'common.home': 'Home',
      'common.contact': 'Contact',
      'common.contactUs': 'Get in touch',
      'common.initiativaDeCarvalho': 'A DeCarvalho initiative',
      'common.footerTag': 'Clear strategy, rigorous delivery and verifiable results.',
      ...
      'contact.lead': 'For commercial requests, partnerships or technical support, contact the DeCarvalho team. We respond with clear next steps suited to your context.',
      'contact.name': 'Name *',
